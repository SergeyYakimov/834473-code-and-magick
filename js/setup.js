...
(function () {
  ...
  window.mainWizard.mainWizardCoat.addEventListener('click', window.mainWizard.getWizardCoatColors);

  window.mainWizard.mainWizardEyes.addEventListener('click', window.mainWizard.getWizardEyesColors);

  window.mainWizard.fireballColor.addEventListener('click', window.mainWizard.getWizardFireballColor);
})();
